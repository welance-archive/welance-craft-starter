...
if echo "$confirm" | grep -q "^YES" ;then
    ...
    printf "#!/bin/sh\n#autogenerated script, do not edit\ndocker exec -it craft_$PROJECT_COORDINATES /data/scripts/schematic-export.sh" >  $SCRIPT_HOME/schema-export.sh
    printf "#!/bin/sh\n#autogenerated script, do not edit\ndocker exec -it craft_$PROJECT_COORDINATES /data/scripts/schematic-import.sh" >  $SCRIPT_HOME/schema-import.sh
    chmod +x $SCRIPT_HOME/schema-*.sh
    # all done 
